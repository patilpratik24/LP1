...
enter total no of elements=>8
 ...
 enter elements=>1 2 5 7 8 9 6 5

Enter(-1 to end) enter key to find=>5

 Key found at position=>3
Enter(-1 to end) enter key to find=>3

 Key not found.
Enter(-1 to end) enter key to find=>7

 Key found at position=>4
Enter(-1 to end) enter key to find=>-1
*/
